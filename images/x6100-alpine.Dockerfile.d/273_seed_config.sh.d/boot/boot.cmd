...
echo ext4load mmc $devnum:1 0x46000000 /boot/zImage
ext4load mmc $devnum:1 0x46000000 /boot/zImage

echo ext4load mmc $devnum:1 0x49000000 /boot/${fdtfile}
ext4load mmc $devnum:1 0x49000000 /boot/${fdtfile}
